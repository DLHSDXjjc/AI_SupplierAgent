...
SEMANTIC_CACHE_KEY_PREFIX = _config["semantic_cache"]["key_prefix"]    # metadata HASH key 前缀
SEMANTIC_CACHE_VECTOR_KEY = _config["semantic_cache"]["vector_key"]    # vectorset key
